...
public class Hikari {
    ...
    public Hikari() {
        this.host = OrbitalPunishments.getInstance().getConfig().getString("database.host");
        this.dbname = OrbitalPunishments.getInstance().getConfig().getString("database.dbName");
        this.port = OrbitalPunishments.getInstance().getConfig().getInt("database.port");
        this.ssl = OrbitalPunishments.getInstance().getConfig().getBoolean("database.ssl");

        this.username = OrbitalPunishments.getInstance().getConfig().getString("database.username");
        this.password = OrbitalPunishments.getInstance().getConfig().getString("database.password");
    }
